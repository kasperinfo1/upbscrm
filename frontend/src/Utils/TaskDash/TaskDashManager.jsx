              ...
              .map((task, index) => (
                ...
                >
                  <div >
                    ...
                    <p style={{color : darkMode ? "black" : "white", whiteSpace: "wrap",}}
                    >
                  ...
                  <div>
                    <div className="d-flex align-items-center  gap-3 justify-content-between p-1">
                      ...
                      <span  style={{ fontSize: ".8rem", color : darkMode ? "black" : "white" }}>
                        {calculateProgress(task).toFixed(2)}%
                      </span>
                    </div>
                    <p style={{color : darkMode ? "black" : "white", fontSize: ".8rem" }}>
