            ...
            {currentItems.map((data, index) => {
                  return (
                    <tr key={index}>
                      ...
                      <td style={rowBodyStyle(darkMode)}>
                        <span className="border border-warning text-warning px-2 py-0 rounded-5">
                          {data.Status}
                        </span>
                      </td>
                      ...
                      onClick={() => props.onEditLeaveApplicationHR(data.data)}
                      tooltip={"Edit Leave"}
                    />
                    <OverLayToolTip
                      style={{ color: darkMode ? "black" : "white" }}
                      icon={<AiOutlineDelete className="fs-5 text-danger" />}
                      onClick={() => onLeaveApplicationHRDelete(
                        data.empObjID,
                        data.data["_id"]
                      )}
