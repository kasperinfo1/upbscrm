...
const AdminCancleTask = () => {
  ...
  return (
    ...
    >
      ...
      {tasks
          .filter((task) => task.status === "Cancelled").length > 0 ? (      <div className="row mx-auto">
            {tasks
                ...
                >
                  ...
                  >
                    <div className="d-flex align-items-center justify-content-between">
                      <h6>{task.Taskname}</h6>
                      <button style={{ cursor: "auto" }} className="btn btn-danger">
                        {task.status}
                      </button>
                    </div>
                    <hr />
                          ...
                          <div className="d-flex flex-column gap-2 my-2">
                            {task.status === "Cancelled" && (
                              <span className="border border-danger px-2 py-1 text-center">
                                This task is cancelled and cannot be re-open for any
                                query contact your admin.
                              </span>
                            )}
                          </div>
                        </div>
