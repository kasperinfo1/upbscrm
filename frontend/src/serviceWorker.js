  ...
  fetch(swUrl)
    .then(response => {
      ...
      if (
        ...
        // No service worker found. This might be a different app. Reload the page.
        ...
        // Service worker found. Proceed with the usual registration.
        registerValidSW(swUrl, config);
      }
    })
    .catch(() => {
